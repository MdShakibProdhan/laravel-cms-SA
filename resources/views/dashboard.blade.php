...
@section('mainBody')
    ...
    <div class="content-body">
        ...
        <div class="container-fluid mt-3">
            ...
            {{-- @extends('serviceView.customIndex'); --}}
            {{-- @extends('serviceView.customIndex') --}}
            {{-- @include('serviceView.customIndex') --}}

            <h3>Service Items Overview</h3>
            <table class="table table-striped"
                style="margin-bottom:50px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px; border-radius:10px ">
                <thead>
                    <tr>
                        <th>Image</th>
                        <th>Name</th>
                ...
                <tbody>
                    @foreach ($services as $service)
                        <tr>
                            <td><img src="{{ asset('images/' . $service->image) }}" width="100px" height="70px"
                                    alt="{{ $service->name }}">
                                {{-- print_r(asset()); --}}
                            </td>
                            <td>{{ $service->name }}</td>
                            {{-- <td>{{ asset('/public/public/image/16788708994960.pic-3.png') }}</td> --}}
                            <td style="max-width:50px; width:45%; height: 10px; overflow:hidden">
                                {{ $service->description }}
                            </td>
                            {{-- <td>
                            ...
                            <div class="active-member">
                                <div class="table-responsive">
                                    <table class="table table-xs mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src={{ asset('adminViewAssets/images/avatar/1.jpg') }}
                                                        class=" rounded-circle mr-3" alt="">Sarah Smith
                                                </td>
                                                <td>iPhone X</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><img src={{ asset('adminViewAssets/images/avatar/2.jpg') }}
                                            ...
                                            <tr>
                                                <td><img src={{ asset('adminViewAssets/images/avatar/3.jpg') }}
                                            ...
                                            <tr>
                                                <td><img src={{ asset('adminViewAssets/images/avatar/6.jpg') }}
                                            ...
                                            <tr>
                                                <td><img src={{ asset('adminViewAssets/images/avatar/4.jpg') }}
                                            ...
                                            <tr>
                                                <td><img src={{ asset('adminViewAssets/images/avatar/5.jpg') }}
                                                        class=" rounded-circle mr-3" alt="">Elizabeth W.
                                                </td>
                                                <td>Notebook Asus</td>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src={{ asset('adminViewAssets/images/users/8.jpg') }} class="rounded-circle"
                                    alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src={{ asset('adminViewAssets/images/users/5.jpg') }} class="rounded-circle"
                                    alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src={{ asset('adminViewAssets/images/users/7.jpg') }} class="rounded-circle"
                                    alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src={{ asset('adminViewAssets/images/users/1.jpg') }} class="rounded-circle"
                                    alt="">
                        ...
                        <div class="card-body">
                            ...
                            <div id="activity">
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src={{ asset('adminViewAssets/images/avatar/1.jpg') }}
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
                                        <h5>Received New Order</h5>
                                        <p class="mb-0">I shared this on my fb wall a few months back,</p>
                                    </div><span class="text-muted ">April 24, 2023</span>
                                </div>
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src={{ asset('adminViewAssets/images/avatar/2.jpg') }}
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img width="35" src={{ asset('adminViewAssets/images/avatar/3.jpg') }}
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
